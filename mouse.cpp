...
BOOL MY_MOUSEDOWN_KEEP(int MOUSE_INPUT_, int milliTime)
{
...
BOOL MY_MOUSE_CLICK(int MOUSE_INPUT_)
{
	if (mouse.OldButton[MOUSE_INPUT_] == 0		//直前は押していなくて
		&& mouse.Button[MOUSE_INPUT_] >= 1)		//今は押しているとき
	{
